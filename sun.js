...
function sunMaker(htmlElement, width, height, interval) {
    ...
    var width = (width < 30 && width > 16)? width : 24;

    var height = (height < 25 && height > 10)? height : 10;

    var interval = (interval < 1500 && interval > 49)? interval : 1000;
